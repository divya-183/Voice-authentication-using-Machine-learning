...
def main():
    model_path = r"C:\\Dekstop\\triplet_loss4"
    use_cuda = True
    ...
    train_dataset = FBanksTripletDataset("C:\\Users\\divya\\OneDrive\\Desktop\\project\\fbanks\\Fbanks_train\\")
    train_loader = DataLoader(train_dataset, batch_size=32, shuffle=True, **kwargs)

    test_dataset = FBanksTripletDataset("C:\\Users\\divya\\OneDrive\\Desktop\\project\\fbanks\\Fbanks_test\\")
    ...
    last_epoch, max_accuracy, train_losses, test_losses, train_positive_accuracies, train_negative_accuracies, test_positive_accuracies, test_negative_accuracies = restore_objects(model_path, (0,0,[], [], [], [], [], [], ))
