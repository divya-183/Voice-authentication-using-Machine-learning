...
def main():
    ...
    train_dataset = FBanksCrossEntropyDataset(r"C:\\Users\\divya\\OneDrive\\Desktop\\project\\fbanks\\Fbanks_train\\")
    train_loader = DataLoader(train_dataset, batch_size=32, shuffle=True, **kwargs)

    test_dataset = FBanksCrossEntropyDataset(r"C:\\Users\\divya\\OneDrive\\Desktop\\project\\fbanks\\Fbanks_test\\")
